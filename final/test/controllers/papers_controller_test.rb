...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { name: @paper.name, score: @paper.score, student_id: @paper.student_id } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { name: @paper.name, score: @paper.score, student_id: @paper.student_id } }
